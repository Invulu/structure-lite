...
if ( ! class_exists( 'Organic_Footer_Modifier' ) ) {
	function structure_lite_admin_footer_notice() {
		...
		printf( __( 'Want to remove or change those pesky footer credits? Get the <a href="%1$s" target="_blank">Footer Change Plugin</a> from Organic Themes!', 'structure-lite' ), 'http://organicthemes.com/footer-change-plugin/' );
		echo '</p></div>';
	}
