...
function structure_lite_admin_notice() {
	...
	<div data-dismissible="notice-structure-lite-30" class="notice updated is-dismissible">
		...
		<p><?php printf( __( 'Enter your email to receive important updates and information from <a href="%1$s" target="_blank">Organic Themes</a>.', 'structure-lite' ), 'https://organicthemes.com' ); ?></p>
